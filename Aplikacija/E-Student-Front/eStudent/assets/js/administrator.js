            ...
            .then((data) => {
              if (data.title == "Unauthorized") alert("Lose korisnicko ime ili sifra.");
                ...
                data.forEach(element => {
                    var p1 = new student(element.id,element.indeks,element.ime,element.prezime,element.email,element.godinaUpisa,element.semestar,element.smer,element.dugovanje);
                    this.dodajStudenta(p1);
                });
                this.crtajOdobreneStudente(document.getElementById("crtajOdobreneStudente"));
              }
            })
        ...
        fetch("https://localhost:7078/getRokovi", {
            ...
            .then((data) => {
              if (data.title == "Unauthorized") alert("Lose korisnicko ime ili sifra.");
                ...
                data.forEach(element => {
                    var p1 = new rok(element.id,element.pocetak_roka,element.kraj_prijave,element.naziv,element.pocetak_prijave,element.zavrsetak_roka);
                    this.dodajRok(p1);
                });
        ...
        fetch("https://localhost:7078/getSatnice", {
            ...
            .then((data) => {
              if (data.title == "Unauthorized") alert("Lose korisnicko ime ili sifra.");
                ...
                data.forEach(element => {
                    var p1 = new satnica(element.id,element.rok_id,element.datum,element.naziv_sale,element.sifra_predmeta,element.vreme);
  ...
  DodajPredmet()
    {
      ...
      if(sifraP!="" && espbP!="" && nazivP!="" && semestarP!="" && smerP!="")
      {
        ...
        fetch("https://localhost:7078/getProfesore", {
            ...
            .then((data) => {
              if (data.title == "Unauthorized") alert("Lose korisnicko ime ili sifra.");
                ...
                data.forEach(element => {
                    var p1 = new profesor(element.email,element.ime,element.prezime,element.godina,element.br_telefona,element.kancelarija);
